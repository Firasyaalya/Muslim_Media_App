...
plugins {
    ...
    id("com.google.devtools.ksp")// Kotlin Symbol Processing, for JSON file processing when parsing the data
}

android {
    namespace = "com.firasya.muslimmediaapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.firasya.muslimmediaapp"
        minSdk = 28
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
