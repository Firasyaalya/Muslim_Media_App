package com.firasya.muslimmediaapp

import android.util.Log
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.firasya.muslimmediaapp.model.network.ApiClient
import com.firasya.muslimmediaapp.model.network.NewsResponse
...
class NewsViewModel :ViewModel(){
    ...
    fun warningForMuslimNews(){
        ApiClient.provideApiService().getWarnForMuslimNews()
            .enqueue(object  :Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
